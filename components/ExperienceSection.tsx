...
export const ExperienceSection: React.FC = () => {
  ...
  return (
    <section id="experience" className="py-16 sm:py-20 bg-slate-100/70 dark:bg-slate-950/60 border-y border-slate-200 dark:border-slate-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
                ...
                <button
                  ...
                  className={`w-full text-left p-3.5 sm:p-4 rounded-xl border transition-all duration-200 outline-none focus:outline-none relative overflow-hidden group cursor-pointer ${
                    isSelected
                      ...
                      : 'bg-white/60 dark:bg-slate-900/40 border-slate-200 dark:border-slate-800/80 hover:bg-white dark:hover:bg-slate-900/80'
                  }`}
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-300 mt-0.5">{exp.company}</p>
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-[11px] sm:text-xs text-slate-500 dark:text-slate-400 mt-1.5">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 sm:p-8 space-y-5 sm:space-y-6 shadow-sm dark:shadow-xl relative">
              
              {/* Role Header */}
              <div className="border-b border-slate-200 dark:border-slate-800 pb-4 sm:pb-6 space-y-2">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-slate-100">
                    {selectedExperience.role}
                  </h3>
                  <span className="text-xs sm:text-sm font-semibold px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-indigo-700 dark:text-indigo-400 border border-slate-200 dark:border-slate-700">
                    {selectedExperience.company}
                  </span>
                </div>
                <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm italic">
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800/80 space-y-3">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {selectedExperience.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-2.5 py-1 rounded-lg text-[11px] sm:text-xs font-medium bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:border-indigo-500/40 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
