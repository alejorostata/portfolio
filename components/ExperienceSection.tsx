            ...
            {EXPERIENCES.map((exp) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl border transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 relative overflow-hidden group ${
                    isSelected
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className={`font-bold text-base transition-colors ${isSelected ? 'text-emerald-400' : 'text-slate-200 group-hover:text-slate-100'}`}>
                          {exp.role}
                        </h3>
                        {exp.isCurrent && (
            ...
            <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 sm:p-8 space-y-6 shadow-xl relative">
              ...
              <div className="border-b border-slate-800 pb-6 space-y-2">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <span className="text-sm font-semibold px-3 py-1 rounded-full bg-slate-800 text-emerald-400 border border-slate-700">
              ...
              <div className="pt-4 border-t border-slate-800/80 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedExperience.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 rounded-lg text-xs font-medium bg-slate-950 border border-slate-800 text-slate-300 hover:border-emerald-500/40 hover:text-emerald-300 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
