      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-6">
            ...
            <div>
              <div className="inline-flex max-w-fit items-start sm:items-center gap-2 px-3 py-1.5 sm:px-3 sm:py-1.5 rounded-xl sm:rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 text-blue-700 dark:text-blue-400 text-[11px] sm:text-xs font-semibold tracking-wide shadow-xs">
                <span className="relative flex h-2 w-2 shrink-0 mt-[4px] sm:mt-0">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-600 dark:bg-blue-500"></span>
                </span>
                <span className="leading-tight text-left text-balance">{t('hero.availabilityBadge')}</span>
              </div>
            </div>
