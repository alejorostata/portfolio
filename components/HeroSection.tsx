                ...
                <div className="space-y-2 overflow-hidden">
                  ...
                  {activeConsoleTab === 'stack' && (
                    <div className="space-y-2 animate-in fade-in duration-200">
                      ...
                      <p><span className="text-blue-400">const</span> <span className="text-amber-300">backend</span> = [<span className="text-blue-300">'Java (Spring Boot)'</span>, <span className="text-blue-300">'C# (.NET)'</span>, <span className="text-blue-300">'Node.js'</span>, <span className="text-blue-300">'APIs'</span>];</p>
